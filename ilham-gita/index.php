...
<body data-key="d9faced3377732b0edf19e90d1bde0cd5de04801c75eb41743" data-url="https://api.ulems.my.id/" data-audio="./assets/music/pure-love-304010.mp3" data-confetti="true" data-time="2024-01-01 09:30:00">
                ...
                <div class="d-flex position-absolute w-100 h-100">
                    <div class="position-relative overflow-hidden vw-100">
                        <div class="position-absolute h-100 w-100 slide-desktop" style="opacity: 0;">
                            <img src="https://hay.galipatstory.id/wp-content/uploads/jet-form-builder/0e57098d0318a954d1443e2974a38fac/2025/12/HAI_4381_cropped_1765855175950-682x1024.webp" data-src="https://img.lazcdn.com/g/ff/kf/S5530a0d17e024242a40be4a1344e6ff0J.jpg_720x720q80.jpg" alt="bg" class="bg-cover-home" style="mask-image: none; opacity: 30%;">
                        </div>
                        <div class="position-absolute h-100 w-100 slide-desktop" style="opacity: 0;">
                            <img src="https://hay.galipatstory.id/wp-content/uploads/jet-form-builder/0e57098d0318a954d1443e2974a38fac/2025/12/HAI_4381_cropped_1765855175950-682x1024.webp" data-src="https://img.lazcdn.com/g/ff/kf/S5530a0d17e024242a40be4a1344e6ff0J.jpg_720x720q80.jpg" alt="bg" class="bg-cover-home" style="mask-image: none; opacity: 30%;">
                        </div>
        ...
        <div class="col-sm-7 col-md-6 col-lg-5 col-xl-4 col-xxl-3 m-0 p-0">
            ...
            <main data-bs-spy="scroll" data-bs-target="#navbar-menu" data-bs-root-margin="25% 0% 0% 0%" data-bs-smooth-scroll="true" tabindex="0">
                ...
                <section id="home" class="bg-light-dark position-relative overflow-hidden p-0 m-0">
                    <img src="https://hay.galipatstory.id/wp-content/uploads/jet-form-builder/0e57098d0318a954d1443e2974a38fac/2025/12/HAI_4381_cropped_1765855175950-682x1024.webp" data-src="./assets/images/bg.webp" alt="bg" class="position-absolute opacity-25 top-50 start-50 translate-middle bg-cover-home">
                    ...
                    <div class="position-relative text-center bg-overlay-auto" style="background-color: unset;">
                        ...
                        <img src="https://hay.galipatstory.id/wp-content/uploads/jet-form-builder/0e57098d0318a954d1443e2974a38fac/2025/12/HAI_4381_cropped_1765855175950-682x1024.webp" data-src="./assets/images/bg.webp" alt="bg" onclick="undangan.guest.modal(this)" class="img-center-crop rounded-circle border border-3 border-light shadow my-4 mx-auto cursor-pointer">
                    ...
                    <div class="overflow-x-hidden pb-4">
                        ...
                        <div class="position-relative">
                            ...
                            <div data-aos="fade-right" data-aos-duration="2000" class="pb-1">
                                <img src="https://hay.galipatstory.id/wp-content/uploads/jet-form-builder/1c786e504985ca58a55bc2552596b068/2025/12/HAI_4397_1-1022x1536.webp" data-src="./assets/images/cowo.webp" alt="cowo" onclick="undangan.guest.modal(this)" class="img-center-crop rounded-circle border border-3 border-light shadow my-4 mx-auto cursor-pointer">
                                <h2 class="font-esthetic m-0" style="font-size: 2.125rem;">Ardi Wijaya</h2>
                                <p class="mt-3 mb-1" style="font-size: 1.25rem;">Putra ke-8 dari</p>
                                <p class="mb-0" style="font-size: 0.95rem;">Bapak Aang Sudrajat (Alm)</p>
                                <p class="mb-0" style="font-size: 0.95rem;">&</p>
                                <p class="mb-0" style="font-size: 0.95rem;">Ibu Yayah Marliah (Almh)</p>
                            </div>
                        ...
                        <div class="position-relative">
                            ...
                            <div data-aos="fade-left" data-aos-duration="2000" class="pb-1">
                                <img src="https://hay.galipatstory.id/wp-content/uploads/jet-form-builder/1c786e504985ca58a55bc2552596b068/2025/12/HAI_4395_1-1022x1536.webp" data-src="./assets/images/cewe.webp" alt="cewe" onclick="undangan.guest.modal(this)" class="img-center-crop rounded-circle border border-3 border-light shadow my-4 mx-auto cursor-pointer">
                                <h2 class="font-esthetic m-0" style="font-size: 2.125rem;">Lesti Ria Rahayu</h2>
                                <p class="mt-3 mb-1" style="font-size: 1.25rem;">Putri ke-1</p>
                                <p class="mb-0" style="font-size: 0.95rem;">Bapak Ujang Setiawan</p>
                                <p class="mb-0" style="font-size: 0.95rem;">&</p>
                                <p class="mb-0" style="font-size: 0.95rem;">Ibu Santi Susanti</p>
                            </div>
                        ...
                        <div class="bg-theme-auto rounded-4 shadow p-3 mx-4 mt-4 text-start" data-aos="fade-up" data-aos-duration="2500">
                            ...
                            <div class="collapse" id="collapseGift">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <p class="m-0 p-0" style="font-size: 0.85rem;"><i class="fa-solid fa-phone-volume me-1"></i>0812345678</p>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <p class="my-0 p-0 text-truncate me-2" style="font-size: 0.85rem;"><i class="fa-solid fa-location-dot me-1"></i>RT 10 RW 02, Desa Pajerukan, Kec. Kalibagor, Kab. Banyumas, Jawa Tengah 53191.</p>
    ...
    <div class="d-flex justify-content-center align-items-center vh-100 w-100 overflow-y-auto">
        <div class="d-flex flex-column text-center">
            ...
            <img src="https://img.lazcdn.com/g/ff/kf/S5530a0d17e024242a40be4a1344e6ff0J.jpg_720x720q80.jpg" data-src="./assets/images/bg.webp" alt="background" class="img-center-crop rounded-circle border border-3 border-light shadow mb-4 mx-auto">
...
<script>
    /**
     * ULEMS FRONTEND PORT (FIXED INITIAL THEME)
     */
    ...
    const theme = {
        // Fungsi baru untuk inisialisasi tema saat pertama kali load
        init: () => {
            const html = document.documentElement;
            // Jika settingan html masih "auto", kita paksa pilih salah satu
            if(html.getAttribute('data-bs-theme') === 'auto') {
                // Cek apakah HP user mode gelap?
                const isSystemDark = window.matchMedia('(prefers-color-scheme: dark)').matches;
                const setMode = isSystemDark ? 'dark' : 'light';
                html.setAttribute('data-bs-theme', setMode);
                
                // Ubah icon tombol sesuai mode
                const btnIcon = document.querySelector('#button-theme i');
                if(btnIcon) {
                    btnIcon.className = isSystemDark ? 'fa-solid fa-sun' : 'fa-solid fa-moon';
                }
            }
        },
        toggle: () => {
    ...
    const audio = {
        bg: new Audio(document.body.getAttribute('data-audio')),
    ...
    const guest = (() => {
        const config = {
            targetDate: document.body.getAttribute('data-time'),
            defaultGuest: "Tamu Spesial"
        };

        const countDownDate = () => {
            // Cek apakah tanggal valid
            let timeString = config.targetDate;
            if(!timeString || timeString === "") timeString = new Date().getFullYear() + "-12-31"; 
            ...
            const update = () => {
                ...
                if (distance < 0) {
                    day.innerText = "00"; hour.innerText = "00"; minute.innerText = "00"; second.innerText = "00";
                    return;
                }

                day.innerText = Math.floor(distance / (1000 * 60 * 60 * 24)).toString().padStart(2, '0');
                hour.innerText = Math.floor((distance % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60)).toString().padStart(2, '0');
                minute.innerText = Math.floor((distance % (1000 * 60 * 60)) / (1000 * 60)).toString().padStart(2, '0');
                second.innerText = Math.floor((distance % (1000 * 60)) / 1000).toString().padStart(2, '0');
            };
        ...
        const showGuestName = () => {
            ...
            const name = params.get('to') || config.defaultGuest;

            const guestBox = document.getElementById('guest-name');
            if(guestBox) {
                const message = guestBox.getAttribute('data-message');
                guestBox.innerHTML = `
                    <small class="d-block mb-1">${message}</small>
                    <div class="fs-4 fw-bold font-esthetic">${util.escapeHtml(name)}</div>
                `;
            }
        ...
        const open = (button) => {
            ...
            button.innerHTML = '<i class="fa-solid fa-spinner fa-spin me-2"></i> Membuka...';

            window.scrollTo(0, 0);

            const root = document.getElementById('root');
            root.classList.remove('opacity-0'); // Hapus class opacity-0
            root.style.opacity = '1'; // Paksa opacity 1
            
            document.getElementById('button-theme').classList.remove('d-none');
            document.getElementById('button-music').classList.remove('d-none');
            ...
            util.changeOpacity(document.getElementById('welcome'), false).then((el) => {
                el.style.display = 'none';
            });
            
            if(typeof AOS !== 'undefined') {
                AOS.init();
                setTimeout(() => AOS.refresh(), 500); // Refresh agar animasi tidak macet
            }
        };
        ...
        const modal = (img) => {
            ...
            const viewBtn = document.getElementById('button-modal-click');

            modalImg.src = img.getAttribute('data-src') || img.src;
            if(downloadBtn) downloadBtn.onclick = () => window.open(modalImg.src, '_blank');
            if(viewBtn) viewBtn.href = modalImg.src;

            const myModal = new bootstrap.Modal(document.getElementById('modal-image'));
            myModal.show();
        };
        ...
        const boot = async () => {
            // Jalankan deteksi tema SEBELUM loading selesai
            theme.init();
            ...
            const int = setInterval(() => {
                ...
                if(w >= 100) {
                    ...
                    util.changeOpacity(document.getElementById('loading'), false).then(el => el.remove());
                    
                    const welcome = document.getElementById('welcome');
                    if(welcome) {
                        welcome.style.display = 'flex';
                        setTimeout(() => util.changeOpacity(welcome, true), 50);
                    }
    ...
    const undangan = {
        ...
        comment: {
            send: (btn) => {
                ...
                const msg = document.getElementById('form-comment').value;
                if(!name || !msg) { alert('Harap isi nama dan ucapan'); return; }
                
                const box = document.getElementById('comments');
                const html = `
                    <div class="mb-3 border-bottom pb-2">
                        <h6 class="fw-bold mb-1">${util.escapeHtml(name)} <span class="badge bg-success" style="font-size:0.6rem">Hadir</span></h6>
                        <p class="small mb-1">${util.escapeHtml(msg)}</p>
                        <small class="text-muted" style="font-size: 0.7rem;">Baru saja</small>
                    </div>`;
                box.innerHTML = html + box.innerHTML;
                document.getElementById('form-comment').value = '';
                alert('Ucapan terkirim (Simulasi)');
            },
            gif: {
                open: () => alert('Fitur GIF belum aktif di mode offline'),
                default: null
            }
        }
    };
